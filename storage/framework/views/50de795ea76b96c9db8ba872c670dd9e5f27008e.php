...
<div class="main">
    <div class="main-top1">
        ...
        <?php echo $__env->make('admin.pengajuancuti.back', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
        <!-- Modal Konfirmasi -->
        <!-- <a href="<?php echo e(route('admin.pengajuancuti.index')); ?>" data-toggle="modal" data-target="#confirmationModal"><i class="fa fa-angle-left"></i></a> -->
    ...
    <div class="cong-box2">
        <form action="<?php echo e(route('admin.pengajuancuti.store')); ?>" method="post" enctype="multipart/form-data">
            <?php echo csrf_field(); ?>
            <div class="content">
                <div class="tglx">
                    <div class="tgl1">
                        <h5>Nama</h5>
                        <!-- <input type="text" name="nama" id="nama" class="date" placeholder="Tuliskan nama, di sini" value="<?php echo e(old('nama')); ?>"> -->
                    ...
                    <div class="tgl1">
                        <h5>Kategori Cuti</h5>
                        <!-- <input type="text" name="kategori" id="kategori" class="date" placeholder="Tuliskan kategori, di sini" value="<?php echo e(old('kategori')); ?>"> -->
                        <div class="form-group1">
                ...
                <div class="keter">
                    <h5>Keterangan</h5>
                    <textarea name="keterangan" id="keterangan" placeholder="Tuliskan Keterangan atau alasan mengambil cuti, di sini"><?php echo e(old('keterangan')); ?></textarea>
                    <!-- cols="122" rows="5" -->
                </div>
                <div class="tgl">
                    <div class="tgl1">
