...
<?php $__env->startSection('content'); ?>
    <div class="main">
        <div class="main-top1">
            ...
            <!-- <a href="<?php echo e(route('admin.perjalanandinas.index')); ?>"><i class="fa fa-angle-left"></i></a> -->
        ...
        <div class="cong-box4">
            <form action="<?php echo e(route('admin.perjalanandinas.store')); ?>" method="post" enctype="multipart/form-data">
                <?php echo csrf_field(); ?>
                <div class="content">
                    <h5>Perusahaan</h5>
                    ...
                    <div class="tglx1">
                        <div class="tgl1">
                            ...
                            <div class="form-group1">
                                ...
                                <?php $__currentLoopData = $regency; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $kota): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <option value="<?php echo e($kota->id); ?>"><?php echo e($kota->name); ?></option>
                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                </select>
                            </div>
                            <!-- <input type="text" name="kota" id="kota" class="date" placeholder="Tuliskan kota keberangkatan, di sini" value="<?php echo e(old('kota')); ?>"> -->
                        </div>
                        <div class="tgl1">
                            <h5>Komisi</h5>
                    ...
                    <div class="button">
                        ...
                        <?php echo $__env->make('admin.perjalanandinas.tambah-anggota', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                    </div>
                    <div class="tglx1">
                        <div class="tgl1">
...
<script type="text/javascript">
    $(function() {
        ...
        $(document).ready(function() {
            $('#id_mitras').on('change', function() {
                ...
                $.ajax({
                    url: "<?php echo e(route('getPosisiById', ':id')); ?>".replace(':id', selectedValue),
                    type: 'GET',
        ...
        $(document).ready(function() {
            $('#id_mitras').on('change', function() {
                ...
                $.ajax({
                    url: "<?php echo e(route('getPosisiById1', ':id')); ?>".replace(':id', selectedValue),
                    type: 'GET',
                    success: function(data) {
                        // Update the gaji_posisi field value here
                        // $('#komisi_dinas').val(data.komisi_dinas);
        ...
        $(document).ready(function() {
            $('#id_mitras').on('change', function() {
                ...
                $.ajax({
                    url: "<?php echo e(route('getPosisiById2', ':id')); ?>".replace(':id', selectedValue),
                    type: 'GET',
                    success: function(data) {
                        // Update the gaji_posisi field value here
                        // $('#komisi_dinas').val(data.komisi_dinas);
    ...
    function openConfirmationModal() {
        ...
        if (mitras.trim() !== '' || kota.trim() !== '' || komisi.trim() !== '' || mulai.trim() !== '' || selesai.trim() !== '' || anggota1.trim() !== '' || anggota2.trim() !== '' || tambah.trim() !== '' || anggota3.trim() !== '' || anggota4.trim() !== '' || pic.trim() !== '' || jabatan.trim() !== '') {
            ...
            window.location.href = "<?php echo e(route('admin.perjalanandinas.index')); ?>";
        }
    }
    ...
    function confirmExitAdd() {
        ...
        // return redirect()->route('admin.pengajuancuti.index');
        // return view('admin.pengajuancuti.index');
        window.location.href = "<?php echo e(route('admin.perjalanandinas.store')); ?>";
