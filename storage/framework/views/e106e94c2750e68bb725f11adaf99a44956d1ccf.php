...
<?php $__env->startSection('content'); ?>
    <div class="main">
        <div class="main-top1">
            ...
            <!-- <a href="<?php echo e(route('admin.mitra.index')); ?>"><i class="fa fa-angle-left"></i></a> -->
        ...
        <div class="cong-box4">
            <form action="<?php echo e(route('admin.mitra.store')); ?>" method="post" enctype="multipart/form-data">
                <?php echo csrf_field(); ?>
                <div class="content">
                    <div class="tglx">
                        <div class="tgl1">
                            <h5>Nama Perusahaan</h5>
                            <input type="text" name="nama_mitra" id="nama_mitra" class="date" placeholder="Tuliskan nama perusahaan, di sini" value="<?php echo e(old('nama_mitra')); ?>">
                        </div>
                        <div class="tgl1">
                            <h5>Provinsi</h5>
                            ...
                            <!-- <input type="text" name="provinsi" id="provinsi" class="date" placeholder="Tuliskan nama provinsi, di sini" value="<?php echo e(old('provinsi')); ?>"> -->
                        </div>
                    </div>
                    <div class="tglx1">
                        <div class="tgl1">
                            ...
                            <!-- <input type="text" name="kota" id="kota" class="date" placeholder="Tuliskan nama kabupaten atau kota, di sini" value="<?php echo e(old('kota')); ?>"> -->
                        </div>
                        <div class="tgl1">
                            <h5>Kecamatan</h5>
                            <div class="form-group1">
                            ...
                            <!-- <input type="text" name="kecamatan" id="kecamatan" class="date" placeholder="Tuliskan nama kecamatan, di sini" value="<?php echo e(old('kecamatan')); ?>"> -->
                        </div>
                    </div>
                    <div class="tglx1">
                        <div class="tgl1">
                            ...
                            <!-- <input type="text" name="kelurahan" id="kelurahan" class="date" placeholder="Tuliskan nama kelurahan, di sini" value="<?php echo e(old('kelurahan')); ?>"> -->
                        </div>
                        <div class="tgl1">
                            <h5>Kode Pos</h5>
                            <input type="text" name="kode_pos" id="kode_pos" class="date" placeholder="Tuliskan kode pos, di sini" value="<?php echo e(old('kode_pos')); ?>">
                        </div>
                    </div>
                    <div class="keter">
                        <h5>Alamat Lengkap</h5>
                        <textarea name="alamat_lengkap" id="alamat_lengkap" cols="122" rows="5" placeholder="Tuliskan alamat lengkap, di sini"><?php echo e(old('alamat_lengkap')); ?></textarea>
                    </div>
                    <div class="tglx1">
                        <div class="tgl1">
                            <h5>PIC Perusahaan</h5>
                            <input type="text" name="nama_PIC_perusahaan" id="nama_PIC_perusahaan" class="date" placeholder="Tuliskan PIC perusahaan, di sini" value="<?php echo e(old('nama_PIC_perusahaan')); ?>">
                        </div>
                        <div class="tgl1">
                            <h5>Jabatan PIC</h5>
                            <input type="text" name="jabatan_PIC" id="jabatan_PIC" class="date" placeholder="Tuliskan jabatan PIC, di sini" value="<?php echo e(old('jabatan_PIC')); ?>">
                        </div>
                    </div>
                    <div class="tglx1">
                        <div class="tgl1">
                            <h5>Nomor PIC</h5>
                            <input type="text" name="nomer_telepon_PIC" id="nomer_telepon_PIC" class="date" placeholder="Tuliskan nomor PIC, di sini" value="<?php echo e(old('nomer_telepon_PIC')); ?>">
                        </div>
                        <div class="tgl1">
                            <h5>Komisi Perjalanan Dinas</h5>
                            <input type="text" name="komisi_dinas" id="komisi_dinas" class="date" placeholder="Tuliskan komisi perjalanan dinas, di sini" value="<?php echo e(old('komisi_dinas')); ?>">
                        </div>
                    </div>
                    <div class="button">
<<<<<<< Updated upstream
    ...
    <script type="text/javascript">
        ...
        function openConfirmationModal() {
            ...
            if (nama.trim() !== '' || provinsi.trim() !== '' || kode.trim() !== '' || alamat.trim() !== '' || pic.trim() !== '' || jabatan.trim() !== '' || nomer.trim() !== '' || komisi.trim() !== '') {
                ...
                window.location.href = "<?php echo e(route('admin.mitra.index')); ?>";
            }
        }
        ...
        function confirmExitAdd() {
            ...
            // return redirect()->route('admin.pengajuancuti.index');
            // return view('admin.pengajuancuti.index');
            window.location.href = "<?php echo e(route('admin.mitra.store')); ?>";
