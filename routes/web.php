...
//
    ...
    Route::get('/admin/perjalanandinas/create', [PerjalanandinasController::class, 'create'])->middleware('laravel10')->name('admin.perjalanandinas.create');
    ...
    Route::get('/admin/karyawan/create', [KaryawanController::class, 'create'])->middleware('laravel10')->name('admin.karyawan.create');
    Route::post('/admin/karyawan/store', [KaryawanController::class, 'store'])->middleware('laravel10')->name('admin.karyawan.store');
